...
const ProfileDropdown = ({ isOpen, toggleDropdown }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center overflow-auto">
          {adminData.picture ? <img src={adminData.picture} alt="Profile Image" className="w-8 h-8 rounded-full" /> : <UserCircle className="text-gray-500" />}
        </div>
